...
<div class="card-header py-3 d-flex justify-content-between align-items-center">
    <h6 class="m-0 font-weight-bold text-primary">Riwayat Penyediaan</h6>
</div>
      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="text-align:center;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> {{ $transaksi->id}}</td>
                <td> {{ $transaksi->pemasok->nama }}</td>
                <td> {{ $transaksi->pegawai->nama }}</td>
                <td> {{ $transaksi->waktu }}</td>
                <td style="width:20%">
                  <a href="{{ route('penyediaan.show', $transaksi->id)}}" class="btn btn-info btn-icon-split btn-sm">
